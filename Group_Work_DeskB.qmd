...
fig.text(0.5, 0.02, 'Figure1a: Best number of topics for summarizing key words', ha='center', va='bottom')

plt.savefig("CoherenceScoreOfLDA.png")
...
plt.savefig("LDA_topic16_wordcloud.png")
...
plt.savefig("Word2Vec_2D_UMAP_Projection.png", dpi=150)
...
fig.savefig("Word2Vec_OSM_geospace.png", dpi=100)  
...
# 保存为 PNG 文件，分辨率为 300 dpi
fig.savefig("Listings_profit_ratio.png", dpi=150)
