...
<img src="Images/Word2Vec_2D_UMAP_Projection.png" 
     onerror="this.onerror=null; this.src='your-backup-image-url.png'"
...
fig.savefig(os.path.join("Images","Word2Vec_OSM_geospace.jpg"), dpi=150)  
...
# save to png，150 dpi
fig.savefig(os.path.join("Images","Listings_profit_ratio.png"), dpi=150)
plt.show()
```
