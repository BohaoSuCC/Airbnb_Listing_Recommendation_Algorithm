...
bib_url = "https://github.com/BohaoSuCC/Groupwork_DeskB/blob/05ead1ddb032b1b686eeeaa10ad435ee0d70c6a1/reference.bib"
...
csl_url = "https://github.com/BohaoSuCC/Groupwork_DeskB/blob/05ead1ddb032b1b686eeeaa10ad435ee0d70c6a1/harvard-cite-them-right.csl"
...
(1)Privacy issues: whether the dataset has the consent of the landlord owner to disclose its information, e.g., house location, name. Geocoded data is privacy-sensitive and highly likely to expose personal privacy when used to study demographic patterns and behaviours[@Vera_van_den_Bemt:2018]. Therefore, obtaining the user's consent is crucial to whether the user's privacy is effectively safeguarded.
...
```{python}
coherence_url = "https://github.com/BohaoSuCC/Groupwork_DeskB/blob/05ead1ddb032b1b686eeeaa10ad435ee0d70c6a1/reference.bib"

# create local path for saving
local_coherence_path = os.path.join(current_dir, "Data","bio.bib")
