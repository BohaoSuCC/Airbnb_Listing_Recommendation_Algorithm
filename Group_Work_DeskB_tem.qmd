...
In pursuing the core interests of its business, Airbnb undoubtedly seeks to foster a positive cycle by promoting competitive listings to renters [@Hoffman2020]. However, the pursuit of competitiveness may inadvertently contribute to homogeneity, counteracting the intended positive cycle [@H_bscher_2022]. Alternatively, Airbnb could actively contribute to the  heterogeneity in diversity of specific regions by engaging in targeted interventions. One effective approach could involve providing personalized guidance to hosts in competitive areas, encouraging them to modify their amenities or property descriptions strategically to enhance their appeal to renters. As well as establishing a framework for communication and collaboration with hosts, offering insights into market trends and suggesting adjustments that align with creating a more diverse array of listings. Overall, the trade-off between promoting competitiveness and maintaining area diversity should be approached with flexibility by implementing a dynamic system that takes into account local preferences, seasonal variations, and emerging trends.
...
In a context where the lack of data is cited as a major limitation in research and decision-making outcomes [@Fonda2021], a registration service could provide some of the information necessary to bridge this gap. Utilizing statistical analysis and modelling, regulatory decisions can be evidence-based, considering the unique characteristics of each area. A collaborative effort between cities and Airbnb is suggested for the development of a centralized registration platform. The streamlined online monitoring and fine collection system could significantly enhance planning authorities' ability to monitor and regulate STL on housing prices, availability, and community well-being.

>>>>>>> ea27b658c5d5aa70e9a05aa2f2ee2c363a15b5f6
## References